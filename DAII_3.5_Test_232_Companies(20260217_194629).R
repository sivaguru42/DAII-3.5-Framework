...
> load_packages_safely(required_packages)
   ...
   ✅ Already available: quantmod
   ✅ Already available: zoo
...
📊 SECTION 1: LOADING FUNDAMENTALS
...
🏦 SECTION 2: LOADING HOLDINGS DATA
> cat(paste(rep("=", 80), collapse = ""), "\n\n")
================================================================================ 
...
📋 SECTION 3: CREATING MASTER TICKER LIST
> cat(paste(rep("=", 80), collapse = ""), "\n\n")
================================================================================ 
...
> panel_data <- load_panel_data()
   ...
   Panel should contain ~232 tickers × 1500 days
> 
...
> cat("   ✅ Panel data saved to:", panel_output, "\n")
   ✅ Panel data saved to: C:\Users\sganesan\OneDrive - dumac.duke.edu\DAII\data\raw/N232_complete_panel.csv 
> 
...
📊 SECTION 5: CREATING COMPANY SNAPSHOT
> cat(paste(rep("=", 80), collapse = ""), "\n\n")
================================================================================ 
...
✅ Snapshot saved to: C:\Users\sganesan\OneDrive - dumac.duke.edu\DAII\data\raw/N245_company_snapshot_FIXED.csv 
> 
> cat("\n📊 FINAL COMPOSITION:\n")
...
🚀 SECTION 6: READY FOR MAIN PIPELINE
> cat(paste(rep("=", 80), collapse = ""), "\n\n")
================================================================================ 
...
> cat("   Next step: Run the main pipeline using:\n")
   Next step: Run the main pipeline using:
> cat("   daii_raw_data <- read.csv('", snapshot_file, "')\n", sep="")
   daii_raw_data <- read.csv('C:\Users\sganesan\OneDrive - dumac.duke.edu\DAII\data\raw/N245_company_snapshot_FIXED.csv')
> 
> # =============================================================================
...
> daii_raw_data <- read.csv(file.path(raw_dir, "N245_company_snapshot_FIXED.csv"), stringsAsFactors = FALSE)
> cat(sprintf("   ✅ Snapshot loaded: %d rows × %d columns\n", nrow(daii_raw_data), ncol(daii_raw_data)))
   ✅ Snapshot loaded: 217 rows × 15 columns
> 
...
📁 Run directory: C:\Users\sganesan\OneDrive - dumac.duke.edu\DAII\data\output/run_20260217_194629 
> 
> # -----------------------------------------------------------------------------
...
+ }
   ...
   ⚠️ Found 25 NA values in features. Imputing with column means...
   ✅ Predictions created successfully
   ⚠️ Target length mismatch, recreating target...
...
+ }
   ⚠️ Found 172 NA values in anomaly_score. Removing for visualization.
   ✅ Histogram saved
   ✅ Scatter plot saved
> 
> # -----------------------------------------------------------------------------
